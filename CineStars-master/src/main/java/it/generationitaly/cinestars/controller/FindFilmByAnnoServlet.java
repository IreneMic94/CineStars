...
@WebServlet("/film-by-anno")
public class FindFilmByAnnoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static PellicolaRepository pellicolaRepository = new PellicolaRepositoryImpl(); 
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int anno  = Integer.parseInt(request.getParameter("#"));
		List<Pellicola> pellicole = pellicolaRepository.findByAnno(anno);
