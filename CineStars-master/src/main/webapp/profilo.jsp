...
class="text-center"
	...
	<div class="row module-border-wrap">
		<div class="module">
			<div class="d-grid gap-2 d-md-flex justify-content-md-start">
				<% if (session == null || session.getAttribute("utenteUsername") == null) {%>
					<a><img src="https://cdn-icons-png.flaticon.com/512/4675/4675304.png" width="37">ELIMINA PROFILO</a>
				<% } else { %>
					<form action="delete-utente" method="post">
	        			<button class="btn btn-outline-info fw-bold" type="submit" onclick="return confirm('Sei sicuro? La cancellazione è permanente. Vuoi continuare?')">ELIMINA PROFILO</button>
			...
			<div class="d-grid gap-2 d-md-flex justify-content-md-end">
				<% if (session == null || session.getAttribute("utenteUsername") == null) {%>
					<a><img src="https://cdn-icons-png.flaticon.com/512/4675/4675304.png" width="37"></a>
				<% } else { %>
	        	<a href="form-servlet-utente?id=<%= utente.getId() %>"><img src="https://cdn-icons-png.flaticon.com/512/4675/4675304.png" width="37"></a>
				<% } %>
			</div>
				<h1 style="color: rgba(205, 206, 215, 255); font-family: Bodoni;"
					class="h3 mb-3 fw-normal">IL TUO PROFILO:</h1>
			...
			<h1 style="margin-top: 3rem; color: rgba(205, 206, 215, 255); font-family: Bodoni;"
			...
			<div class="column_content flex scroller loaded module">
					...
					<div class="card-style">
							...
							<form action="delete-watchlist" method="post">
								<input type="hidden" name="idPellicola" value="<%=watchList.getPellicola().getId()%>">
								<button class="btn btn-outline-info fw-bold" type="submit" name="utenteId" onclick="return confirm('Vuoi rimuovere questo titolo dalla tua watchlist?')" 
								value="<%=session.getAttribute("utenteId")%>">Elimina</button>
							</form>
					</div>
				<%
				}
				...
				<div>
					...
					<form action="delete-recensione" method="post">
								<button class="btn btn-outline-info fw-bold" style="margin-bottom:2rem" name="idRecensione" value="<%=recensione.getId() %>">Elimina</button>
					</form>
				</div>
				<hr class="featurette-divider">
				<%
